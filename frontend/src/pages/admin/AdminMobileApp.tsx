    ...
    >
      <div>
        <h1 className="text-3xl font-bold text-foreground tracking-tight flex items-center gap-2">
          <Smartphone className="w-8 h-8 text-pink-500" /> Mobile App
        </h1>
      ...
      <Card className="bg-gradient-to-br from-card/60 via-card/40 to-card/60 border-border/40 shadow-lg">
        ...
        <CardContent>
          <div className="h-32 flex flex-col items-center justify-center text-muted-foreground gap-2">
            <Smartphone className="w-10 h-10 text-pink-400 mb-2" />
            <span className="text-lg font-semibold">
              Feature under construction
            </span>
            <span className="text-sm">
              This page will allow you to manage the restaurant's mobile app
              features.
            </span>
          </div>
        </CardContent>
