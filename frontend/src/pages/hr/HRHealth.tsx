    ...
    >
      <div>
        <h1 className="text-3xl font-bold text-foreground tracking-tight flex items-center gap-2">
          <Heart className="w-8 h-8 text-pink-500" /> Health Records
        </h1>
        <p className="text-muted-foreground mt-2">
          Employee health data management coming soon.
        </p>
      </div>
      <Card className="bg-gradient-to-br from-card/60 via-card/40 to-card/60 border-border/40 shadow-lg">
        <CardHeader>
          <CardTitle className="text-foreground">Health Records</CardTitle>
        </CardHeader>
        <CardContent>
          <div className="h-32 flex flex-col items-center justify-center text-muted-foreground gap-2">
            ...
            <span className="text-sm">
              This page will allow you to manage employee health records.
            </span>
          </div>
        </CardContent>
      </Card>
