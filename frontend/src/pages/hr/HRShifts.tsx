    ...
    >
      <div>
        <h1 className="text-3xl font-bold text-foreground tracking-tight flex items-center gap-2">
          <Clock className="w-8 h-8 text-blue-500" /> Shift Management
        </h1>
        <p className="text-muted-foreground mt-2">
          Shift planning & rotation coming soon.
        </p>
      </div>
      <Card className="bg-gradient-to-br from-card/60 via-card/40 to-card/60 border-border/40 shadow-lg">
        <CardHeader>
          <CardTitle className="text-foreground">Shift Management</CardTitle>
        </CardHeader>
        <CardContent>
          <div className="h-32 flex flex-col items-center justify-center text-muted-foreground gap-2">
            ...
            <span className="text-sm">
              This page will allow you to manage employee shifts.
            </span>
          </div>
        </CardContent>
      </Card>
